m_pa <- phylopath::define_model_set(
  ...
  # PARTIAL BRAIN MODELS + NO EGG FEEDING LINK ----
  ...
  # PARTIAL BRAIN MODELS + NO EGG FEEDING LINK + NO WEIGHT TIMEFED LINK ----
  ...
  # PARTIAL BRAIN MODELS + NO WEIGHT TIMEFED LINK ----
  ...
  # *REV* PARTIAL BRAIN MODELS + NO EGG FEEDING LINK ----
  pa_Xdevmd_devfoc2 = c(
    weight ~ clutch_size,
    #clutch_size ~ weight,
  ...
  # *REV* PARTIAL BRAIN MODELS + NO EGG FEEDING LINK + NO WEIGHT TIMEFED LINK ----
  pa_Xdevmd_devfoc3 = c(
    weight ~ clutch_size,
    #clutch_size ~ weight,
  ...
  # *REV* PARTIAL BRAIN MODELS + NO WEIGHT TIMEFED LINK ----
  pa_Xdevmd_devfoc4 = c(
    weight ~ clutch_size,
    #clutch_size ~ weight,
