m_pa <- phylopath::define_model_set(
  ...
  # PARTIAL brain_log MODELS + NO EGG FEEDING LINK ----
  ...
  # PARTIAL brain_log MODELS + NO EGG FEEDING LINK + NO WEIGHT TIMEFED LINK ----
  ...
  # PARTIAL brain_log MODELS + NO WEIGHT TIMEFED LINK ----
  ...
  # *REV* PARTIAL brain_log MODELS + NO EGG FEEDING LINK ----
  pa_Xdevmd_devfoc2 = c(
    weight ~ clutch_size,
    #clutch_size ~ weight,
  ...
  # *REV* PARTIAL brain_log MODELS + NO EGG FEEDING LINK + NO WEIGHT TIMEFED LINK ----
  pa_Xdevmd_devfoc3 = c(
    weight ~ clutch_size,
    #clutch_size ~ weight,
  ...
  # *REV* PARTIAL brain_log MODELS + NO WEIGHT TIMEFED LINK ----
  pa_Xdevmd_devfoc4 = c(
    weight ~ clutch_size,
    #clutch_size ~ weight,
